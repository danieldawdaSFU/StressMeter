...
class StressAdapter(context: Context, private val list: ArrayList<HomeFragment.StressData>):
    ArrayAdapter<HomeFragment.StressData?>(context, 0, list) {
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        val (timestamp, level) = list[position]
        timeView.text = timestamp.toString()
